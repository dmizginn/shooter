...
from time import \
    time as timer  # Yorumlayıcının bu işlevi pygame zaman modülünde aramasını önlemek için zaman algılama işlevini içe aktarıyoruz, kendisine farklı bir ad veriyoruz
